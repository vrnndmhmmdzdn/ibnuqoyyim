    ...
    <form wire:submit="createJadwalPelajaran">
                ...
                <div class="flex items-end">
                    <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-4 rounded-lg">
                        ...
                        <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">
                            JadwalPelajaran hari ini: Hanya menampilkan waktu mulai dari {{ \Carbon\Carbon::now()->addMinutes(30)->format('H:i') }} ke atas
                        </p>
                        @endif
                    </div>
                </div>
        ...
        <div class="mb-8">
            ...
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 rounded-lg mb-6">
                <h4 class="font-semibold mb-3 text-lg text-gray-900 dark:text-gray-100">Ringkasan JadwalPelajaran</h4>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <div class="font-semibold text-lg text-gray-900 dark:text-gray-100">Rp {{ $guru }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input 
                        ...
                        required
                    >
                    @error('pelajaran') <span class="text-red-500 dark:text-red-400 text-sm">{{ $message }}</span> @enderror
                </div>
                ...
                <div>
                    ...
                    <input 
                        ...
                        required
                    >
                    @error('hari') <span class="text-red-500 dark:text-red-400 text-sm">{{ $message }}</span> @enderror
                </div>
                ...
                <div>
                    ...
                    @error('guru') <span class="text-red-500 dark:text-red-400 text-sm">{{ $message }}</span> @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="px-4 py-3 bg-gray-100 dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-lg font-semibold text-lg text-gray-900 dark:text-white">
                        Rp {{ number_format($guru * $duration, 0, ',', '.') }}
                    </div>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea 
                        wire:model="guru"
                        rows="3"
                        placeholder="Catatan khusus untuk jadwal ini (opsional)..."
                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                    ></textarea>
                </div>
            </div>
