<style>
    ...
    /* Efek glow untuk penilaian cards premium */
    .penilaian-card-premium {
    ...
    .penilaian-card-premium:hover {
        transform: translateY(-8px) scale(1.02);
        box-shadow: 0 20px 40px rgba(249, 115, 22, 0.2);
        border-color: rgba(249, 115, 22, 0.6);
    }
    
    .penilaian-card-premium::before {
        content: '';
        position: absolute;
        top: -2px;
        left: -2px;
    ...
    .penilaian-card-premium:hover::before {
    ...
    /* Dark mode variants */
    .dark .penilaian-card-premium {
        background-color: #374151 !important;
        border-color: rgba(249, 115, 22, 0.4);
    }
    
    .dark .penilaian-card-premium:hover {
        background-color: #4b5563 !important;
        box-shadow: 0 20px 40px rgba(249, 115, 22, 0.3);
        border-color: rgba(249, 115, 22, 0.8);
    }
    
    .dark .penilaian-card-premium::before {
        background: linear-gradient(45deg, rgba(249, 115, 22, 0.6), rgba(234, 88, 12, 0.6), rgba(249, 115, 22, 0.6));
    }
    
    .dark .penilaian-card-premium:hover::before {
